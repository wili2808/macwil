    ...
    <div class="row">
        <form action="" class="formulario col-sm-12 col-md-8 col-md-offset-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="Nombre" value='$nombre'>
            </div>

            <div class="form-group">
                <label for="apellido">Apellido:</label>
                <input type="text" class="form-control" id="apellido" placeholder="Nombre" value="$apellido">
            </div>

            <div class="form-group">
                <label for="">Correo Electronico:</label>
                <input type="email" class="form-control" id="email" placeholder="Correo Electronico" value="$email">
            </div>
